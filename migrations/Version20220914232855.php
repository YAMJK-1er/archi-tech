 ...
 */
final class Version20220914232855 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tache ADD duree_reel VARCHAR(255) DEFAULT NULL COMMENT \'(DC2Type:dateinterval)\'');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tache DROP duree_reel, CHANGE intitule intitule VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
